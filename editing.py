...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_name', help='training image name', default='3-VAM9owl-o_frames_00000001.jpg')
    # parser.add_argument('--ref_dir', help='input reference dir', default='Input/Editing')
    parser.add_argument('--ref_dir', help='input reference dir', default='Input/Editing/3-VAM9owl-o/start_scale=2,input=0.5')
    ...
    #     print("output already exist")
        ...
        if (opt.editing_start_scale < 1) | (opt.editing_start_scale > (len(Gs)-1)):
            ...
            mask = functions.read_image_dir('Input/Editing/3-VAM9owl-o/start_scale=2,input=0.5/mask.png', opt)
            ...
            plt.imsave('Output/Editing/3-VAM9owl-o/start_scale=2,input=0.5/%s.png' % (opt.ref_name[:-4]), functions.convert_image_np(out.detach()), vmin=0, vmax=1)
            ...
            # plt.imsave('Output/Editing/3-VAM9owl-o/start_scale=2_mask/%s.png' % (opt.ref_name[:-4]), functions.convert_image_np(out.detach()), vmin=0, vmax=1)
